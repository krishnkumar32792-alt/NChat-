          ...
          <Pressable
            onLongPress={() => {
              ...
              const action = window.prompt(
                isSaved
                  ? 'Type DELETE to delete or UNSAVE to unsave this message.'
                  : 'Type DELETE to delete or SAVE to save this message.'
              );

              if (action?.toUpperCase() === 'DELETE') {
                deleteMessage(id || '', item.id);
              } else if (action?.toUpperCase() === 'SAVE') {
                toggleSaveMessage(id || '', item.id);
              } else if (action?.toUpperCase() === 'UNSAVE') {
                toggleSaveMessage(id || '', item.id);
              }
            }}
          >
