  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sourceRow}>
        <Pressable style={styles.cameraButton} onPress={() => router.push('/camera' as any)}>
          <Text style={styles.cameraButtonText}>📷 Open Camera + Filters</Text>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  cameraButton: { flex: 1, height: 48, borderRadius: 13, backgroundColor: '#111', alignItems: 'center', justifyContent: 'center' },
  cameraButtonText: { color: '#fff', fontWeight: '900', fontSize: 12 },
  galleryButton: { width: 105, height: 48, borderRadius: 13, backgroundColor: '#eee', alignItems: 'center', justifyContent: 'center' },
  galleryButtonText: { color: '#111', fontWeight: '800', fontSize: 12 },
  photoBox: {
    height: 350,
    borderRadius: 18,
